...
| Origen: contenido del editor vacío o por debajo del umbral (`empty_editor`, umbral por filtro) | `Test_Content_Source::test_empty_editor_triggers_rendered`, `Test_Document_Builder::test_empty_editor_is_rendered_and_its_body_is_reused_on_fallback` | A |
